...
public class Carro extends AbstractModel {
	...
	public Carro() {
		super(true, true);
		modelCarro = new GameObject(MyGame.loader.loadModel(Gdx.files.internal("cars/lotus/Lotus.g3db")));
		for (Material m : modelCarro.materials) {
			m.remove(ColorAttribute.Emissive);
		}
		modelCarro.transform.setToTranslation(-84, 0, -74);
	}

	public Carro(boolean autonomous) {
		this();
